...
function Order({ params }) {
  ...
  function onApprove(data, actions) {
    return actions.order.capture().then(async function (details) {
      try {
        ...
        enqueueSnackbar('A Compra está paga', { variant: 'success' });
      } catch (err) {
  ...
  async function deliverOrderHandler() {
    try {
      ...
      enqueueSnackbar('A Compra foi entregue', { variant: 'success' });
    } catch (err) {
          ...
          <Grid item md={9} xs={12}>
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>
                  Status:{' '}
                  {isDelivered ? `entregue ${deliveredAt}` : 'entrega pendente'}
                </ListItem>
              </List>
            </Card>
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>
                  Status: {isPaid ? `pago ${paidAt}` : 'pagamento pendente'}
                </ListItem>
              </List>
            </Card>
            <Card className={classes.section}>
