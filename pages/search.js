        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            <Grid item>
              ...
              {rating !== 'all' && ' : Avaliação ' + rating + ' & up'}
              {(query !== 'all' && query !== '') ||
              category !== 'all' ||
              brand !== 'all' ||
              rating !== 'all' ||
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                <MenuItem value="featured">Produtos em Destaque</MenuItem>
                <MenuItem value="lowest">Preço: menor para o maior</MenuItem>
                <MenuItem value="highest">Preço: maior para o menor</MenuItem>
                <MenuItem value="toprated">Por Avaliação de Clientes</MenuItem>
                <MenuItem value="newest">Produtos novos</MenuItem>
              </Select>
            </Grid>
          </Grid>
